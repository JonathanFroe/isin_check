# ISIN-Check ![GitHub release (latest by date and asset)](https://img.shields.io/github/downloads/JonathanFroe/isin_check/latest/isin-check.exe?color=green&logo=Github)
